...
cells = [
    # Header
    {
        ...
        "metadata": {},
        "source": [
            "# 🧠 Complete End-to-End Brain MRI 4-Class Classification Framework\n",
            "### Custom Baseline Attention CNN (CBAM) & Transfer Learning (ResNet50, DenseNet121, EfficientNetV2B0)\n",
            "\n",
            "This Jupyter Notebook contains the complete, self-contained pipeline for 4-class brain tumor classification (**Glioma**, **Meningioma**, **No Tumor**, **Pituitary**).\n",
            "\n",
            "### Workflow Sections:\n",
            "1. **Environment Setup & Seed Fixation**\n",
            "2. **Stratified 70/15/15 Dataset Partitioning & Class Weighting**\n",
            "3. **Zero-Leakage Data Augmentation & Preprocessing**\n",
            "4. **Model Architecture Definitions** (Baseline Attention CNN, ResNet50, DenseNet121, EfficientNetV2B0)\n",
            "5. **Two-Stage Training & Optimization**\n",
            "6. **Comprehensive Metric Evaluation** (Accuracy, Precision, Sensitivity, Specificity, F1, ROC-AUC)\n",
            "7. **Visualization of Diagnostic Curves & Confusion Matrices**\n",
    ...
    # Section 2 Markdown
    {
        ...
        "source": [
            ...
            "Partitions the dataset into 70% Training (4,824 images), 15% Validation (1,034 images), and 15% Testing (1,034 images)."
        ]
    },
    # Section 2 Code
    {
    ...
    # Section 3 Markdown
    {
        ...
        "source": [
            ...
            "Data augmentation is applied **strictly to the training set** to prevent data leakage."
        ]
    },
    # Section 3 Code
    {
    ...
    # Section 4 Markdown
    {
        ...
        "source": [
            ...
            "Defines Baseline Attention CNN (CBAM), ResNet50, DenseNet121, and EfficientNetV2B0 with Stage 2 unfreezing (keeping Batch Normalization layers frozen)."
        ]
    },
    # Section 4 Code
    {
    ...
    # Section 5 Markdown
    {
        ...
        "source": [
            ...
            "Computes Accuracy, Precision, Sensitivity (Recall), Specificity, Macro F1, and ROC-AUC for any trained model."
        ]
    },
    # Section 5 Code
    {
    ...
    # Section 6 Markdown
    {
        ...
        "source": [
            ...
            "Visualizes class activation heatmaps overlay on test MRI slices."
        ]
    },
    # Section 6 Code
    {
...
with open("notebooks/Brain_MRI_Classification_Complete_Pipeline.ipynb", "w") as f:
    json.dump(notebook, f, indent=2)

print("Saved complete 100% comprehensive Jupyter Notebook!")
